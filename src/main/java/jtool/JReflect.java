...
public final class JReflect {
    ...
    private JReflect(final Class<?> type) {
        this(type, type);
    }

    private JReflect(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link JReflect} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static JReflect reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static JReflect reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static JReflect reflect(final Class<?> clazz)
            throws ReflectException {
        return new JReflect(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static JReflect reflect(final Object object)
            throws ReflectException {
        return new JReflect(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link JReflect} instance
     */
    public JReflect newInstance(Object... args) {
    ...
    private JReflect newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new JReflect(
     ...
     * @return the single {@link JReflect} instance
     */
    public JReflect field(final String name) {
        try {
            Field field = getField(name);
            return new JReflect(field.getType(), field.get(object));
     ...
     * @return the single {@link JReflect} instance
     */
    public JReflect field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof JReflect) {
            return ((JReflect) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public JReflect method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public JReflect method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private JReflect method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof JReflect && object.equals(((JReflect) obj).get());
    }
